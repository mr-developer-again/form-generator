...
Arad::GeneratingForm::SwitchButton::SwitchButton(QWidget* parent)
...
void Arad::GeneratingForm::SwitchButton::paintEvent(QPaintEvent *e)
{
    QPainter p(this);
    p.setPen(Qt::NoPen);
    if (isEnabled()) {
...
void Arad::GeneratingForm::SwitchButton::mouseReleaseEvent(QMouseEvent *e)
{
...
void Arad::GeneratingForm::SwitchButton::enterEvent(QEvent *e)
{
    setCursor(Qt::PointingHandCursor);
    QAbstractButton::enterEvent(e);
}

QSize Arad::GeneratingForm::SwitchButton::sizeHint() const
{
